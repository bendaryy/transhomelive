...
// this is for receiver address
        ...
        $myFileToJson = fopen('https://e-invoice.volmr.com\public/images\SourceDocumentJson.json', "w") or die("unable to open file");
   ...
   public function draft(Request $request)
    {
       ...
       $validated = $request->validate([
        ...
        $myFileToJson = fopen('https://e-invoice.volmr.com\public/images\SourceDocumentJson.json', "w") or die("unable to open file");
        fwrite($myFileToJson, $trnsformed);
         $path = 'https://e-invoice.volmr.com\public/images\SourceDocumentJson.json';
...
// this function for signature
    ...
    public function openBat()
    {
        ...
        shell_exec('https://e-invoice.volmr.com\public/images/SubmitInvoices2.bat');
        $path = 'https://e-invoice.volmr.com\public/images/FullSignedDocument.json';
        $path2 = 'https://e-invoice.volmr.com\public/images/Cades.txt';
        $path3 = 'https://e-invoice.volmr.com\public/images/CanonicalString.txt';
        $path4 = 'https://e-invoice.volmr.com\public/images/SourceDocumentJson.json';
